...
vim.keymap.set("n", "<C-d>", "<C-d>", { desc = "Move cursor half a page down and center screen" })
vim.keymap.set("n", "<C-u>", "<C-u>", { desc = "Move cursor half a page up and center screen" })
...
vim.keymap.set("n", "<C-k>", "<cmd>Treewalker Up<cr>zz", { silent = true })
vim.keymap.set("n", "<C-j>", "<cmd>Treewalker Down<cr>zz", { silent = true })
vim.keymap.set("n", "<C-h>", "<cmd>Treewalker Left<cr>zz", { silent = true })
vim.keymap.set("n", "<C-l>", "<cmd>Treewalker Right<cr>zz", { silent = true })

-- vim.keymap.set("v", "<C-k>", "<cmd>Treewalker Up<cr>jzz", { silent = true })
vim.keymap.set("v", "<C-j>", "<cmd>Treewalker Down<cr>kzz", { silent = true })
vim.keymap.set("v", "<C-h>", "<cmd>Treewalker Left<cr>zz", { silent = true })
vim.keymap.set("v", "<C-l>", "<cmd>Treewalker Right<cr>zz", { silent = true })
