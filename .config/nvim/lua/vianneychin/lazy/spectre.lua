		...
		require("spectre").setup({
			...
			mapping = {
				["tab"] = {
					...
					desc = "(Spectre) Next query",
				},
				["shift-tab"] = {
					map = "<S-Tab>",
					cmd = "<cmd>lua require('spectre').tab_shift()<cr>",
					desc = "(Spectre) Previous query",
				},
				["toggle_line"] = {
					map = "dd",
					cmd = "<cmd>lua require('spectre').toggle_line()<CR>",
					desc = "(Spectre) Toggle item",
				},
				["enter_file"] = {
					map = "<cr>",
					cmd = "<cmd>lua require('spectre.actions').select_entry()<CR>",
					desc = "(Spectre) Open file",
				},
				-- ["send_to_qf"] = {
				-- 	map = "<leader>q",
				...
				["toggle_bbbblive_update"] = {
					map = "tu",
					cmd = "<cmd>lua require('spectre').toggle_live_update()<CR>",
					desc = "(Spectre) Update when vim writes to file",
				},
				["toggle_ignore_case"] = {
					map = "ti",
