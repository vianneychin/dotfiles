	...
	config = function()
		require("tiny-inline-diagnostic").setup({
			...
			hi = {
				...
				hint = "DiagnosticHint",
				arrow = "NonText",
				background = "#14141c", -- Can be a highlight or a hexadecimal color (#RRGGBB)
				mixing_color = "#14141c", -- Can be None or a hexadecimal color (#RRGGBB). Used to blend the background color with the diagnostic background color with another color.
			},
			options = {
